...
以下示例展示了本擴展在Element Web / OpenClaw界面中的渲染效果，以及複雜LaTeX公式的顯示情況。

![OpenClaw Matrix Element Web LaTeX render example 1](images/latex-example-1.png)

![OpenClaw Matrix Element Web LaTeX render example 2](images/latex-example-2.png)
...
The following examples show rendering in the Element Web / OpenClaw interface and a stress-test LaTeX formula layout.
